"""Tab Generatore - Code Generator integrato in ToolManager V13"""
...
class TabGeneratore:
    ...
    def _create_ui(self):
        ...
        # Commento
        ctk.CTkLabel(output, text="Commento CNC:", font=get_font("body", bold=True)).pack(anchor="w", pady=(10, 5))
        ...
        ctk.CTkButton(output, text="📋 Copia", width=100, height=30,
                     **get_button_style("primary", "small"),
                     command=self._copia_comm).pack(anchor="w", pady=(0, 15))
        
        # Genera
        ctk.CTkButton(output, text="✅ GENERA CODICE", width=200, height=40,
        ...
        ctk.CTkButton(btn_frame, text="🏠 SCAFFALE", width=150, height=45,
                     **get_button_style("success", "large"),
                     command=self._aggiungi_scaffale).pack(side="left", padx=5)
        
        ctk.CTkButton(btn_frame, text="🔧 MACCHINA", width=150, height=45,
                     **get_button_style("primary", "large"),
                     command=self._aggiungi_macchina).pack(side="left", padx=5)
        
        ctk.CTkButton(btn_frame, text="📦 SMONTATI", width=150, height=45,
    ...
    def _on_tipo_change(self, *args):
        ...
        if dati.get('has_r2'):
            ...
            self.r2_label.configure(text="X:")
            self.r2_entry.configure(state="normal")
        else:
    ...
    def _copia_comm(self):
        ...
        if comm != "...":
            ...
            messagebox.showinfo("✅", f"Copiato: {comm}")
