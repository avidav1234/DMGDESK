@echo off
REM ========================================
REM Tool Manager V12.4 - Build Script
REM Versione ONEDIR (cartella + exe)
REM Più veloce da avviare, ma genera cartella
REM ========================================

echo.
echo ========================================
echo   TOOL MANAGER V12.4 - BUILD EXE
echo   Versione ONEDIR
echo ========================================
echo.
...
REM Build con PyInstaller - ONEDIR
...
echo ========================================
echo.
echo Percorso: dist\ToolManager\ToolManager.exe
echo.
echo NOTA: Distribuisci tutta la cartella dist\ToolManager
